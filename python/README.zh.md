...
# DMS (Dunimd Middleware Service) - Python 绑定
...
**DMS (Dunimd Middleware Service)** — 一个高性能的 Rust 中间件框架，带有 Python 绑定。专为企业级规模构建，具有模块化架构、内置可观测性和分布式系统支持。
...
**Q: 如何添加新模块？**
A: 使用现有的模块接口并通过 DMSAppBuilder 注册。
