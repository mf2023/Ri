...
<h1 style="display: flex; flex-direction: column; align-items: center; gap: 12px; margin-bottom: 8px;">
  ...
  <span style="font-size: 0.6em; color: #666; font-weight: normal;">适用于 Java 的 DMSC 库</span>
</h1>
...
**DMSC (Dunimd Middleware Service)** — 一个高性能的 Rust 中间件框架，带有 Java 绑定。专为企业级规模构建，具有模块化架构、内置可观测性和分布式系统支持。
...
**Q: 如何处理异常？**
A: 使用 try-catch 捕获 `DMSCError` 异常。
