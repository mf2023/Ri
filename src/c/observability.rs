...
use crate::observability::{DMSCObservabilityConfig, DMSCTracer, DMSCMetricsRegistry};
...
c_constructor!(dmsc_observability_config_new, CDMSCObservabilityConfig, DMSCObservabilityConfig, DMSCObservabilityConfig::default());
