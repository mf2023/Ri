...
use crate::protocol::{DMSCProtocolConfig, DMSCProtocolManager, DMSCFrame};
...
c_constructor!(dmsc_protocol_config_new, CDMSCProtocolConfig, DMSCProtocolConfig, DMSCProtocolConfig::default());
