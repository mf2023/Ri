...
//! for the Ri framework, supporting PKCS#11 devices and TPM 2.0 chips. It
...
//!
//! ```rust,ignore
//! use ri::protocol::hsm::{RiHSMManager, RiHSMType, RiKeyInfo};
//!
//! async fn example() -> RiResult<()> {
//!     // Initialize HSM manager
//!     let mut manager = RiHSMManager::new();
//!
