    ...
    impl KyberKEM {
        ...
        pub fn with_algorithm(algorithm: super::super::RiPostQuantumAlgorithm) -> Self {
            let algo = match algorithm {
                super::super::RiPostQuantumAlgorithm::Kyber512 => KyberAlgorithm::Kyber512,
                super::super::RiPostQuantumAlgorithm::Kyber768 => KyberAlgorithm::Kyber768,
                super::super::RiPostQuantumAlgorithm::Kyber1024 => KyberAlgorithm::Kyber1024,
        ...
        pub fn encapsulate(&self, public_key: &[u8]) -> RiResult<super::super::KEMResult> {
            use oqs::kem::Kem;
...
compile_error!("Kyber module requires the 'protocol' feature");
